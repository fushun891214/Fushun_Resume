...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://fushun181.com/}{\Large 張富順}} & Email: \href{mailto:fushun891214@gmail.com}{fushun891214@gmail.com}\\
  \href{https://fushun181.com/}{fushun181.com} & 手機: \href{tel:+886968733583}{+886-968733583} \\
\end{tabular*}
...
\section{技能}
  \resumeSubHeadingListStart
    ...
    \item
      \textbf{AI 應用開發}
      \resumeItemListStart
        \item\small{熟悉 LLM 環境配置，如 Ollama 或 NVIDIA NIM、Google Studio 等}
        \item\small{熟悉 RAG 應用開發，如 Vector RAG、Graph RAG、Hybrid RAG 等}
        \item\small{熟悉 AI Agent 應用開發，並擅長使用 Skill、Tools、MCP 等}
        \item\small{熟悉 Agentic AI 應用開發，透過 LangChain、LangGraph 開發或自建 OpenClaw 等}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
